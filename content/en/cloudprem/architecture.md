...
- [**Accept external requests from Datadog**][1]: Provide Datadog with a DNS endpoint for gRPC requests and configure a public Ingress toaccept those requests.
- [**Reverse connection**][2]: Let CloudPrem initiate bi-directional gRPC requests to Datadog.
...
[2]: /cloudprem/configure/reverse_connection/
